...
function generateMedicalFallback(question: string): string {
  ...
  if (q.includes("معلمات") || q.includes("مشرف") || q.includes("مريم") || q.includes("هيا") || q.includes("بشاير") || q.includes("جواهر") || q.includes("فريق") || q.includes("إما") || q.includes("اما")) {
...
5. استفسارات حول مشرفات المشروع (أ. مريم، أ. هيا، أ. بشاير، أ. جواهر) أو فريق التنفيذ (فريق إمـَـا).
...
async function startServer() {
  ...
  app.get("/api/credits", (req, res) => {
    res.json({
      supervisors: ["أ. مريم", "أ. هيا", "أ. بشاير", "أ. جواهر"],
      team: "فريق إمـَـا",
...
المشروع منجز بـ:
- إشراف المعلمات الفاضلات: أ. مريم • أ. هيا • أ. بشاير • أ. جواهر
...
- إذا سأل المستخدم عن المعلمات المشرفات أو فريق العمل أو القائمين على المشروع، اذكر بوضوح وتقدير كبير:
  "إشراف المعلمات الفاضلات: أ. مريم، أ. هيا، أ. بشاير، أ. جواهر | تصميم وتنفيذ: فريق إمـَـا".
